...
export const content = {
  tr: {
    ...
    contact: {
      ...
      note: "Form altyapısı yayın aşamasında hosting veya form servisiyle bağlanacaktır.",
      placeholders: {
        name: "Adınız ve soyadınız",
        company: "Kurum veya şirket adınız",
        contact: "ornek@firma.com / +90 ...",
      ...
      details: [
        ...
        { icon: Phone, label: "Telefon", value: "+90 000 000 00 00" },
      ],
    },
    footer: {
  ...
  en: {
    ...
    contact: {
      ...
      note: "The form backend will be connected during publishing through hosting or a form service.",
      placeholders: {
        name: "Your full name",
        company: "Institution or company name",
        contact: "name@company.com / +90 ...",
      ...
      details: [
        ...
        { icon: Phone, label: "Phone", value: "+90 000 000 00 00" },
      ],
    },
    footer: {
